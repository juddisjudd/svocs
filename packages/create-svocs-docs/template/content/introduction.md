...
Head to [Quick Start](/docs/getting-started) to add your first real page, or jump straight to [Navigation](/docs/navigation) if you already have content and just want to organize it.
